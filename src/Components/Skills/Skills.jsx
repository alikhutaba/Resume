        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-sm-6 skils-col">
              ...
              <hr></hr>
              <Skill name="React / Redux" percent="90"></Skill>
              <Skill name="JavaScript" percent="80"></Skill>
              <Skill name="HTML(5)" percent="95"></Skill>
              <Skill name="CSS(3)" percent="95"></Skill>
          ...
          <div className="row">
            ...
            <div className="col-sm-6 skils-col">
              ...
              <Skill name="Maven" percent="50"></Skill>
              <Skill name="Git" percent="90"></Skill>
            </div>
            {/* RIGHT */}
            <div className="col-sm-6 skils-col">
              <Skill name="OOP" percent="100"></Skill>
              <Skill name="Linux" percent="40"></Skill>
